...
const cores = document.querySelectorAll(".color-selector")
...
const picoles = document.querySelectorAll(".icon")
...
document.addEventListener("click", (event) => {
    ...
    if (window.screen.width <= 800) {
        if (event.target.parentNode == searchBar || event.target == search) {
